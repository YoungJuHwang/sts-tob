...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse" >
   ...
   <ul class="nav navbar-nav"   style="padding-top: 50px; margin: 0 auto; ">
      ...
      <li class="dropdown" style="padding-right: 100px;"><a href="${context}/book/Book"
         ...
         aria-haspopup="true" aria-expanded="false">BOOK <span class="caret"></span></a><ul class="dropdown-menu" style="padding-right: 100px">
            <li><a href="${context}/book/Book">전체 목록</a></li>
            <li><a href="#">외국도서</a></li>
